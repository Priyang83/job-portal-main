...
router.put("/rating", jwtAuth, (req, res) => {
  ...
  if (user.type === "recruiter") {
    ...
    Rating.findOne({
      ...
      .then((rating) => {
        if (rating === null) {
          ...
          Application.countDocuments({
                    ...
                    Rating.aggregate([
                      ...
                      .then((result) => {
                        ...
                        JobApplicant.findOneAndUpdate(
                          ...
                          .catch((err) => {
                            res.status(400).json({ message: err.message || "Error updating applicant's average rating" });
                          });
                      })
                      .catch((err) => {
                        res.status(400).json({ message: err.message || "Error aggregating applicant ratings" });
                      });
                  })
                  .catch((err) => {
                    res.status(400).json({ message: err.message || "Error saving applicant rating" });
                  });
              } else {
                // you cannot rate
                res.status(400).json({
            ...
            .catch((err) => {
              res.status(400).json({ message: err.message || "Error counting accepted applicants" });
            });
        } else {
      ...
      .catch((err) => {
        res.status(400).json({ message: err.message || "Error finding applicant rating" });
      });
  } else {
      ...
      .then((rating) => {
        ...
        if (rating === null) {
          ...
          Application.countDocuments({
                    ...
                    Rating.aggregate([
                      ...
                      .then((result) => {
                        ...
                        Job.findOneAndUpdate(
                          ...
                          .catch((err) => {
                            res.status(400).json({ message: err.message || "Error updating job's average rating" });
                          });
                      })
                      .catch((err) => {
                        res.status(400).json({ message: err.message || "Error aggregating job ratings" });
                      });
                  })
                  .catch((err) => {
                    res.status(400).json({ message: err.message || "Error saving job rating" });
                  });
              } else {
                // you cannot rate
                res.status(400).json({
            ...
            .catch((err) => {
              res.status(400).json({ message: err.message || "Error counting accepted jobs" });
            });
        } else {
          // update the rating
          rating.rating = data.rating;
